    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="ingredient" type="text" id="ingredientContent"/>
                <br>
                <label for="quantity">Quantité :</label>
                <input class="form-control" name="quantity" type="number" min="0" id="quantityValue"/>
                <select class="form-control" name="mesure" id="mesureValue">
                    <option value=""></option>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <textarea class="form-control" name="description" id="etapeContent" rows="4" cols="30"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-12">
